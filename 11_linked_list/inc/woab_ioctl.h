...
#define WOAB_DEVICE_READ_CACHE _IOR(WOAB_IOCTL_IOC_MAGIC, 3, int)
#define WOAB_DEVICE_WRITE_CACHE _IOW(WOAB_IOCTL_IOC_MAGIC, 4, int)

#define WOAB_IOCTL_IOC_MAXNR (4)

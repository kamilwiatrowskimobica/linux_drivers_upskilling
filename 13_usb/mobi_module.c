...
/* from dmsg cmd you will get idVendor and idProduct */
#define USB_VENDOR_ID       ( 0x0951 )      //USB device's vendor ID
#define USB_PRODUCT_ID      ( 0x1666 )      //USB device's product ID
                        ...
                        const struct usb_device_id *id)
{
    ...
    // allow to use a correct driver
    return 1;  //return 0 indicates we are managing this device
}
